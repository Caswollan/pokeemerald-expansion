...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_FELINE_PROWESS = 321,
    ABILITY_BONE_ZONE = 322,
    ABILITY_MOUNTAINEER = 323,
    ABILITY_PHANTOMIZE = 324,
    ABILITY_SELF_SUFFICIENT = 325,
    ABILITY_SNOW_FORCE = 326,
    ABILITY_RAGING_BOXER = 327,
    ABILITY_HORN_FORCE = 328,
    ABILITIES_COUNT_CUSTOM_ABILITIES,

    ABILITIES_COUNT = ABILITIES_COUNT_CUSTOM_ABILITIES,
};
