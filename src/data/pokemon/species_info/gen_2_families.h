...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_NONE, ABILITY_BLAZING_SOUL },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_FRISK, ABILITY_ADAPTABILITY },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_GLISCOR, CONDITIONS({IF_TIME, TIME_NIGHT}, {IF_HOLD_ITEM, ITEM_RAZOR_FANG})},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GLISCOR}
                            ),
    #endif
    },
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_SNOW_FORCE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRESSURE, ABILITY_SNOW_FORCE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LINKING_CORD, SPECIES_URSALUNA},
    ...
    [SPECIES_MAGCARGO] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 85 : 50,
        .baseAttack    = 50,
        .baseDefense   = 120,
        .baseSpeed     = 30,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_SNOW_FORCE, ABILITY_THICK_FAT },
    #else
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .baseAttack    = 55,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 110 : 85,
        .baseSpeed     = 35,
        .baseSpAttack  = 65,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 110 : 85,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STURDY, ABILITY_SAND_RUSH, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_GRAY,
