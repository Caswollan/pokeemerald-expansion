...
enum __attribute__((packed)) Ability
{
    ...
    //NEW
    ABILITY_BLAZING_SOUL = ABILITIES_COUNT_GEN9,
    ABILITY_DEMORALISE = 312,
    ABILITY_FELINE_PROWESS = 313,
    ABILITY_BONE_ZONE = 314,
    ABILITY_HYDRO_BARRAGE = 315,
    ABILITY_FOURFOLD_STRIKE = 316,
    ABILITY_MOUNTAINEER = 317,
    ABILITY_PHANTOMIZE = 318,
    ABILITY_SELF_SUFFICIENT = 319,
    ABILITY_DRAGONIZE = 320,
    ABILITY_SPICY_SPRAY = 321,
    ABILITIES_COUNT_NEW,
