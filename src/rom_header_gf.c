...
__attribute__((section(".text.header_gf"))) USED static const struct GFRomHeader sGFRomHeader = {
    ...
    .bagCountItems = (BAG_ITEMS_COUNT > 255) ? 255 : BAG_ITEMS_COUNT,
    .bagCountKeyItems = (BAG_KEYITEMS_COUNT > 255) ? 255 : BAG_KEYITEMS_COUNT,
    .bagCountPokeballs = (BAG_POKEBALLS_COUNT > 255) ? 255 : BAG_POKEBALLS_COUNT,
    .bagCountTMHMs = (BAG_TMHM_COUNT > 255) ? 255 : BAG_TMHM_COUNT,
    .bagCountBerries = (BAG_BERRIES_COUNT > 255) ? 255 : BAG_BERRIES_COUNT,
