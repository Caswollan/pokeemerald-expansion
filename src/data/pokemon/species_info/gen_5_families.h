...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_MUNNA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNAWARE, ABILITY_SYNCHRONIZE, ABILITY_TELEPATHY },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_VANILLITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_VANILLISH}),
    },
    ...
    [SPECIES_DEERLING_SPRING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_SAP_SIPPER, ABILITY_HORN_FORCE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_CUBCHOO] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_SNOW_FORCE, ABILITY_SLUSH_RUSH, ABILITY_RATTLED },
    #else
    ...
    [SPECIES_BEARTIC] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_SNOW_FORCE, ABILITY_SLUSH_RUSH, ABILITY_SWIFT_SWIM },
    #else
