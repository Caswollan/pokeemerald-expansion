...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_SNORLAX_MEGA = 1577,
    SPECIES_GARBODOR_MEGA = 1578,
    SPECIES_ORBEETLE_MEGA = 1579,
    SPECIES_DREDNAW_MEGA = 1580,
    SPECIES_COALOSSAL_MEGA = 1581,
    SPECIES_FLAPPLE_MEGA = 1582,
    SPECIES_APPLETUN_MEGA = 1583,
    SPECIES_SANDACONDA_MEGA = 1584,
    SPECIES_TOXTRICITY_MEGA = 1585,
    SPECIES_CENTISKORCH_MEGA = 1586,
    SPECIES_HATTERENE_MEGA = 1587,
    SPECIES_GRIMMSNARL_MEGA = 1588,
    SPECIES_COPPERAJAH_MEGA = 1589,
