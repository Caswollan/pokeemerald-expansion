...
enum __attribute__((packed)) Item
{
    ...
    // Charms
    ITEM_OVAL_CHARM = 754,
    ITEM_SHINY_CHARM = 755,
    ITEM_CATCHING_CHARM = 756,
    ITEM_EXP_CHARM = 757,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 758,
    ITEM_GRACIDEA = 759,
    ITEM_REVEAL_GLASS = 760,
    ITEM_DNA_SPLICERS = 761,
    ITEM_ZYGARDE_CUBE = 762,
    ITEM_PRISON_BOTTLE = 763,
    ITEM_N_SOLARIZER = 764,
    ITEM_N_LUNARIZER = 765,
    ITEM_REINS_OF_UNITY = 766,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 767,
    ITEM_Z_POWER_RING = 768,
    ITEM_DYNAMAX_BAND = 769,
    ...
    ITEM_GOOD_ROD = 774,
    ITEM_SUPER_ROD = 775,
    ITEM_DOWSING_MACHINE = 776,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 777,
    ITEM_VS_SEEKER = 778,
    ITEM_TM_CASE = 779,
    ITEM_BERRY_POUCH = 780,
    ITEM_POKEMON_BOX_LINK = 781,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 782,
    ITEM_POWDER_JAR = 783,
    ITEM_WAILMER_PAIL = 784,
    ITEM_POKE_RADAR = 785,
    ITEM_POKEBLOCK_CASE = 786,
    ITEM_SOOT_SACK = 787,
    ITEM_POKE_FLUTE = 788,
    ITEM_FAME_CHECKER = 789,
    ITEM_TEACHY_TV = 790,

    // Story Key Items
    ITEM_SS_TICKET = 791,
    ITEM_EON_TICKET = 792,
    ITEM_MYSTIC_TICKET = 793,
    ITEM_AURORA_TICKET = 794,
    ITEM_OLD_SEA_MAP = 795,
    ITEM_LETTER = 796,
    ITEM_DEVON_PARTS = 797,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 798,
    ITEM_DEVON_SCOPE = 799,
    ITEM_BASEMENT_KEY = 800,
    ITEM_SCANNER = 801,
    ITEM_STORAGE_KEY = 802,
    ITEM_KEY_TO_ROOM_1 = 803,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 804,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 805,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 806,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Pre-Gen VI name
    ITEM_METEORITE = 807,
    ITEM_MAGMA_EMBLEM = 808,
    ITEM_CONTEST_PASS = 809,
    ITEM_PARCEL = 810,
    ITEM_OAKS_PARCEL = ITEM_PARCEL, // Pre-Gen IV name
    ITEM_SECRET_KEY = 811,
    ITEM_BIKE_VOUCHER = 812,
    ITEM_GOLD_TEETH = 813,
    ITEM_CARD_KEY = 814,
    ITEM_LIFT_KEY = 815,
    ITEM_SILPH_SCOPE = 816,
    ITEM_TRI_PASS = 817,
    ITEM_RAINBOW_PASS = 818,
    ITEM_TEA = 819,
    ITEM_RUBY = 820,
    ITEM_SAPPHIRE = 821,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 822,
    ITEM_CLEAR_AMULET = 823,
    ITEM_PUNCHING_GLOVE = 824,
    ITEM_COVERT_CLOAK = 825,
    ITEM_LOADED_DICE = 826,
    ITEM_AUSPICIOUS_ARMOR = 827,
    ITEM_BOOSTER_ENERGY = 828,
    ITEM_BIG_BAMBOO_SHOOT = 829,
    ITEM_GIMMIGHOUL_COIN = 830,
    ITEM_LEADERS_CREST = 831,
    ITEM_MALICIOUS_ARMOR = 832,
    ITEM_MIRROR_HERB = 833,
    ITEM_SCROLL_OF_DARKNESS = 834,
    ITEM_SCROLL_OF_WATERS = 835,
    ITEM_TERA_ORB = 836,
    ITEM_TINY_BAMBOO_SHOOT = 837,

    ITEM_BUG_TERA_SHARD = 838,
    ITEM_DARK_TERA_SHARD = 839,
    ITEM_DRAGON_TERA_SHARD = 840,
    ITEM_ELECTRIC_TERA_SHARD = 841,
    ITEM_FAIRY_TERA_SHARD = 842,
    ITEM_FIGHTING_TERA_SHARD = 843,
    ITEM_FIRE_TERA_SHARD = 844,
    ITEM_FLYING_TERA_SHARD = 845,
    ITEM_GHOST_TERA_SHARD = 846,
    ITEM_GRASS_TERA_SHARD = 847,
    ITEM_GROUND_TERA_SHARD = 848,
    ITEM_ICE_TERA_SHARD = 849,
    ITEM_NORMAL_TERA_SHARD = 850,
    ITEM_POISON_TERA_SHARD = 851,
    ITEM_PSYCHIC_TERA_SHARD = 852,
    ITEM_ROCK_TERA_SHARD = 853,
    ITEM_STEEL_TERA_SHARD = 854,
    ITEM_WATER_TERA_SHARD = 855,

    ITEM_ADAMANT_CRYSTAL = 856,
    ITEM_GRISEOUS_CORE = 857,
    ITEM_LUSTROUS_GLOBE = 858,

    ITEM_BLACK_AUGURITE = 859,
    ITEM_LINKING_CORD = 860,
    ITEM_PEAT_BLOCK = 861,
    ITEM_BERSERK_GENE = 862,

    ITEM_FAIRY_FEATHER = 863,
    ITEM_SYRUPY_APPLE = 864,
    ITEM_UNREMARKABLE_TEACUP = 865,
    ITEM_MASTERPIECE_TEACUP = 866,
    ITEM_CORNERSTONE_MASK = 867,
    ITEM_WELLSPRING_MASK = 868,
    ITEM_HEARTHFLAME_MASK = 869,
    ITEM_HEALTH_MOCHI = 870,
    ITEM_MUSCLE_MOCHI = 871,
    ITEM_RESIST_MOCHI = 872,
    ITEM_GENIUS_MOCHI = 873,
    ITEM_CLEVER_MOCHI = 874,
    ITEM_SWIFT_MOCHI = 875,
    ITEM_FRESH_START_MOCHI = 876,
    ITEM_GLIMMERING_CHARM = 877,
    ITEM_METAL_ALLOY = 878,
    ITEM_STELLAR_TERA_SHARD = 879,

    ITEM_JUBILIFE_MUFFIN = 880,
    ITEM_REMEDY = 881,
    ITEM_FINE_REMEDY = 882,
    ITEM_SUPERB_REMEDY = 883,
    ITEM_AUX_EVASION = 884,
    ITEM_AUX_GUARD = 885,
    ITEM_AUX_POWER = 886,
    ITEM_AUX_POWERGUARD = 887,
    ITEM_CHOICE_DUMPLING = 888,
    ITEM_SWAP_SNACK = 889,
    ITEM_TWICE_SPICED_RADISH = 890,
    ITEM_POKESHI_DOLL = 891,

    ITEM_STRANGE_BALL = 892,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 893,
    ITEM_VICTREEBELITE = 894,
    ITEM_STARMINITE = 895,
    ITEM_DRAGONINITE = 896,
    ITEM_MEGANIUMITE = 897,
    ITEM_FERALIGITE = 898,
    ITEM_SKARMORITE = 899,
    ITEM_FROSLASSITE = 900,
    ITEM_EMBOARITE = 901,
    ITEM_EXCADRITE = 902,
    ITEM_SCOLIPITE = 903,
    ITEM_SCRAFTINITE = 904,
    ITEM_EELEKTROSSITE = 905,
    ITEM_CHANDELURITE = 906,
    ITEM_CHESNAUGHTITE = 907,
    ITEM_DELPHOXITE = 908,
    ITEM_GRENINJITE = 909,
    ITEM_PYROARITE = 910,
    ITEM_FLOETTITE = 911,
    ITEM_MALAMARITE = 912,
    ITEM_BARBARACITE = 913,
    ITEM_DRAGALGITE = 914,
    ITEM_HAWLUCHANITE = 915,
    ITEM_ZYGARDITE = 916,
    ITEM_DRAMPANITE = 917,
    ITEM_FALINKSITE = 918,
    ...
    // Custom Items
    ITEM_INFINITE_CANDY = 938,
    ITEM_BUTTERFRITE = 939,
    ITEM_MACHAMPITE = 940,
    ITEM_KINGLERITE = 941,
    ITEM_LAPRASITE = 942,
    ITEM_SNORLAXITE = 943,
    ITEM_GARBODORITE = 944,
    ITEM_ORBEETLITE = 945,
    ITEM_DREDNAWITE = 946,
    ITEM_COALOSSITE = 947,
    ITEM_FLAPPLITE = 948,
    ITEM_APPLITE = 949,
    ITEM_SANDACONDITE = 950,
    ITEM_TOXTRICITITE = 951,
    ITEM_CENTISKITE = 952,
    ITEM_HATTERENITE = 953,
    ITEM_GRIMMSNARITE = 954,
    ITEM_COPPERAJITE = 955,
